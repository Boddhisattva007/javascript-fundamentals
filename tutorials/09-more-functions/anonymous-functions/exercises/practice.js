...
let delayedPing = setTimeout(() => console.log(`Echo Received: Object detected at 12,000km.`), 3000);
...
let klaxonTimer = setTimeout(() => console.log(`🚨 Emergency magnetic shields are now online!`), 1000);